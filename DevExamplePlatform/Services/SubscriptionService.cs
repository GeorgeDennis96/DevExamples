...
//        //public bool SetSubscriptionRequiredRole(string SubscriptionName,string RequiredPermission)
//        //{
//        //    try
//        //    {
//        //        var model = GetSubscription(SubscriptionName);
//        //        model.RequiredPermission = RequiredPermission;
//        //        var result = SubscriptionCollection.ReplaceOne<SubscriptionModel>(a => a.Name == SubscriptionName, model);
//        //        if (result.ModifiedCount > 0)
//        //        {
//        //            return true;
//        //        }
